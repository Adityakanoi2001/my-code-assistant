package com.github.aksh2000.mycodeassistant.settings
...
class AppSettingsComponent {
    ...
    init {
        myMainPanel = FormBuilder.createFormBuilder()
            .addLabeledComponent(JBLabel("Api Key:"), myApiKey, 1, false)
            .addLabeledComponent(JBLabel("Model: "), myChatGptModel, 1, false)
